        ...
        await prisma.paymentSession.create({
            data: {
                ...
                onwardJourney: {
                    ...
                    pickupLatitude: onwardJourney.pickupCoordinates?.latitude || null,
                    pickupLongitude: onwardJourney.pickupCoordinates?.longitude || null,
                    stops: onwardJourney.stops || [],
                    stopsLatitudes: onwardJourney.stopsCoordinates?.map((c: { latitude: number }) => c.latitude) || [],
                    stopsLongitudes: onwardJourney.stopsCoordinates?.map((c: { longitude: number }) => c.longitude) || [],
                    dropoffLocation: onwardJourney.dropoffLocation,
                    dropoffLatitude: onwardJourney.dropoffCoordinates?.latitude || null,
                    dropoffLongitude: onwardJourney.dropoffCoordinates?.longitude || null,
                    distance: onwardJourney.distance || null,
                    duration: onwardJourney.duration || null,
                ...
                returnJourney: returnJourney
                    ? {
                          ...
                          pickupLatitude: returnJourney.pickupCoordinates?.latitude || null,
                          pickupLongitude: returnJourney.pickupCoordinates?.longitude || null,
                          stops: returnJourney.stops || [],
                          stopsLatitudes: returnJourney.stopsCoordinates?.map((c: { latitude: number }) => c.latitude) || [],
                          stopsLongitudes: returnJourney.stopsCoordinates?.map((c: { longitude: number }) => c.longitude) || [],
                          dropoffLocation: returnJourney.dropoffLocation,
                          dropoffLatitude: returnJourney.dropoffCoordinates?.latitude || null,
                          dropoffLongitude: returnJourney.dropoffCoordinates?.longitude || null,
                          distance: returnJourney.distance || null,
                          duration: returnJourney.duration || null,
