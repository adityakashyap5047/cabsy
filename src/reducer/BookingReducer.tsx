    ...
    case "INITIALIZE_RETURN_JOURNEY":
      return {
        ...
        returnJourney: {
          ...
          pickupCoordinates: state.onward.dropoffCoordinates,
          dropoffLocation: state.onward.pickupLocation || "",
          dropoffCoordinates: state.onward.pickupCoordinates,
          stops: [...state.onward.stops].reverse(),
          stopsCoordinates: state.onward.stopsCoordinates ? [...state.onward.stopsCoordinates].reverse() : [],
